...
#追加分
FEW_PRODUCTS = "ご好評につき，在庫数が残りわずかです。購入をご希望の場合、お早めのご注文をおすすめいたします。"
ICON_FEW_PRODUCTS = ":material/warning:"
OUT_OF_STOCK = "申し訳ございませんが、本商品は在庫切れとなっております。入荷までもうしばらくお待ちください。"
ICON_OUT_OF_STOCK = ":material/error:"
